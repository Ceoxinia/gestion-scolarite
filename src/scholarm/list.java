...
public class list {
	 ...
	 public void table_load()
	    {
	     try
	     {
	    pst = con.prepareStatement("select * from student order by CodeS");
	    rs = pst.executeQuery();
	...
	private void initialize() {
	    ...
	    scrollPane.setBounds(114, 48, 680, 496);
